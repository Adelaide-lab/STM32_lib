...
void OLED_ColorTurn(uint8_t i)
{
	if(i==0)
		{
			OLED_Write(0xA6,OLED_COMMAND);//������ʾ
		}
	if(i==1)
		{
			OLED_Write(0xA7,OLED_COMMAND);//��ɫ��ʾ
		}
}
...
void OLED_DisplayTurn(uint8_t i)
{
	if(i==0)
		{
			OLED_Write(0xC8,Cmd_Mode);//������ʾ
			OLED_Write(0xA1,Cmd_Mode);
		}
	if(i==1)
		{
			OLED_Write(0xC0,Cmd_Mode);//��ת��ʾ
...
{
	OLED_Write(0x8D,Cmd_Mode);//��ɱ�ʹ��
	OLED_Write(0x14,Cmd_Mode);//������ɱ�
	OLED_Write(0xAF,Cmd_Mode);//������Ļ
}
